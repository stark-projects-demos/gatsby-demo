  ...
  <Layout>
    ...
    <main id="Hero" className="frame-13874">
      ...
      <div className="content-2">
        <div className="headline">
          ...
          <div className="body">
            With our project management, communication, and file sharing tools,
            you can work together seamlessly from anywhere in the world.
          </div>
        </div>
    ...
    <section id="Value-prop-1" className="value-prop-1-2">
      ...
      <div className="content-6">
        ...
        <div className="body">
          With features like project management, task delegation, collaboration,
          and real-time notifications, you&#x27;ll have everything you need to
    ...
    <section id="Value-prop-2" className="value-prop-2">
      <div className="content-3">
        ...
        <div className="body">
          ...
          and voice call features. Keep everyone up-to-date on project progress
          and updates.
        </div>
      </div>
      <StaticImage
        src="../images/Illustration-1-1.png"
        loading="lazy"
        width="564.5"
        height="713.5"
            ...
            <div className="frame-13901">
              ...
              <div className="bullets-6">
                <div className="bullets-7">
                  ...
                  <div className="feature-2">Access to all of Pro features</div>
                </div>
                <div className="bullets-7">
            ...
            <div className="frame-13902">
              ...
              <div className="bullets-6">
                ...
                <div className="bullets-7">
                  ...
                  <div className="feature-2">Access to advanced analytics</div>
                </div>
                <div className="bullets-7">
                  <div className="bullet-point-wrapper-4">
                    <StaticImage
    ...
    <section id="Value-prop-3" className="frame-13877">
      <StaticImage
        src="../images/Illustration-2-1.png"
        loading="lazy"
        width="738"
        height="586.5"
        alt="Pieces of the team sync user interface. One large calendar with meetings with chat bubbles and avatars around it"
    ...
    <section id="Value-prop-4" className="value-prop-4">
      <div className="content-3">
        ...
        <div className="body">
          ...
          chat feature allows you to quickly communicate with your team and get
          the support you need to meet all project requirements.
        </div>
      </div>
      <StaticImage
        src="../images/Illustration-3-1.png"
        loading="lazy"
        width="516"
        height="388.5"
 ...
 */
export const Head = () => <Seo title="TeamSyn" />
